...
4.  **Drag and Drop** your images or folders onto the window or use the file picker.
5.  Check the progress bar and wait for the "Processing completed!" message.
6.  **Output**: Upscaled images are saved in the original folder or the selected output folder with `_upscaled` appended to the filename and stored in **PNG** format.
